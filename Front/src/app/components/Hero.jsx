    ...
    <section className="dark:bg-gray-800  mt-20 dark:text-gray-100">
      <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-40 lg:flex-row lg:justify-between">
        ...
        <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
          <h1 className="text-5xl font-bold leadi sm:text-6xl">BrainStorm</h1>
          <p className="mt-6 mb-8 text-lg sm:mb-12">
            Descubre un mundo de posibilidades en nuestro marketplace líder en
            inteligencia artificial y robots diseñados para adaptarse a tus
            necesidades.
          </p>
