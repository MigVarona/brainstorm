export default function HeroMark() {
    return (
        ...
        <section className="mt-20  overflow-hidden">
          ...
          <div
            className="relative overflow-hidden bg-cover bg-no-repeat bg-[50%] h-[500px] bg-[url('https://www.publicdomainpictures.net/pictures/530000/velka/cute-robot-cartoon-1693394430KKj.jpg')]">
            <div
              ...
              <div className="flex h-full items-center justify-center">
                <div className="px-6 text-center text-white md:px-12">
                  ...
                  El Marketplace  Nº1 en España <br /><span></span>
                  </h1>
          ...
          <div className="mt-20 font-bold gap-10 flex items-center justify-center">
          <a className="link link-hover">DISPOSITIVOS</a>
          <a className="link link-hover">ROBOTS</a>
          <a className="link link-hover">IA</a>
          </div>
        </section>
